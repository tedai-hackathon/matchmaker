...
export default function TherapieServiceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TherapieService(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TherapieServiceCreateForm")}
      {...rest}
    >
      <TextField
        label="Service"
