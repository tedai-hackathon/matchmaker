...
export default function PersonTitleUpdateForm(props) {
  const {
    id: idProp,
    personTitle: personTitleModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = personTitleRecord
      ? { ...initialValues, ...personTitleRecord }
      : initialValues;
  ...
  const [personTitleRecord, setPersonTitleRecord] =
    React.useState(personTitleModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(PersonTitle, idProp)
        : personTitleModelProp;
      setPersonTitleRecord(record);
    };
    queryData();
  }, [idProp, personTitleModelProp]);
  React.useEffect(resetStateValues, [personTitleRecord]);
  const validations = {
    Language: [],
    Title: [],
    Gender: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            PersonTitle.copyOf(personTitleRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PersonTitleUpdateForm")}
      {...rest}
    >
      <TextField
        label="Language"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || personTitleModelProp)}
