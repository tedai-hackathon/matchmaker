...
export default function CustomerUpdateForm(props) {
  ...
  const [InternalCustomerID, setInternalCustomerID] = React.useState(
    initialValues.InternalCustomerID
  );
  ...
  const resetStateValues = () => {
    const cleanValues = customerRecord
      ...
      : initialValues;
    setInternalCustomerID(cleanValues.InternalCustomerID);
    setErrors({});
  };
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            value = result?.InternalCustomerID ?? value;
          }
          if (errors.InternalCustomerID?.hasError) {
            runValidationTasks("InternalCustomerID", value);
          }
          setInternalCustomerID(value);
        }}
        onBlur={() =>
          runValidationTasks("InternalCustomerID", InternalCustomerID)
        }
        errorMessage={errors.InternalCustomerID?.errorMessage}
        hasError={errors.InternalCustomerID?.hasError}
        {...getOverrideProps(overrides, "InternalCustomerID")}
      ></TextField>
      <Flex
