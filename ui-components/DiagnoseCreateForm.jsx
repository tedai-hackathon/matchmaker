...
export default function DiagnoseCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setDiagnose(initialValues.Diagnose);
    setErrors({});
  };
  const validations = {
    Diagnose: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Diagnose0(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DiagnoseCreateForm")}
      {...rest}
    >
      <TextField
        label="Diagnose"
