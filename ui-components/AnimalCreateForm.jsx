...
export default function AnimalCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setNameAbbreviation(initialValues.NameAbbreviation);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Animal(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AnimalCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
